...
document.addEventListener('DOMContentLoaded', () => {
    const animateElements = document.querySelectorAll('.section-header, .about-content, .event-card, .timeline-item, .gallery-item, .contact-content');
...
function createBackToTopButton() {
    ...
    backToTop.addEventListener('mouseenter', () => {
        ...
        backToTop.style.boxShadow = '0 6px 20px rgba(255, 107, 53, 0.4)';
    });
    
    backToTop.addEventListener('mouseleave', () => {
        backToTop.style.transform = 'translateY(0)';
        backToTop.style.boxShadow = '0 4px 15px rgba(255, 107, 53, 0.3)';
    });
}
...
console.log(`
🎉 Welcome to Baliyatra 2025 Website!
🚢 Celebrating Odisha's Maritime Heritage
✨ Built with modern web technologies
📱 Fully responsive design
🎨 Beautiful animations and interactions

For more information, visit: https://baliyatra2025.com
`);
